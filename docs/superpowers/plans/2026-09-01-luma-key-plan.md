...
- [x] **Step 3: Write failing no-setter and dynamic stability coverage**
...
- [x] **Step 4: Run the focused runtime tests and verify the expected red state**
...
- [x] **Step 1: Add the enum and optional config fields**
...
- [x] **Step 3: Apply inclusive fragment discards**
...
- [x] **Step 1: Run the complete required verification**
...
- [x] **Step 2: Review the diff against the design**
